   ...
   let buttons = [{
     ...
     },     
     {
      index: 1, 
       ...
       url: 'https://www.instagram.com/belu_ngas'
       }
       }, 
       {
     index: 2, 
